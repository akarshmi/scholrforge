...
export default function FilterPanel({ filters, onFiltersChange }: FilterPanelProps) {
  ...
  return (
    <>
      ...
      <motion.aside
        className="dark-scroll glass rounded-xl p-4 sticky top-[4.5rem] max-h-[calc(100vh-6rem)] overflow-y-auto space-y-5"
      ...
      >
        ...
        <div>
          ...
          <div className="dark-scroll space-y-1.5 max-h-52 overflow-y-auto pr-1">
            {allTechs.map((tech) => (
              <label
                key={tech.name}
