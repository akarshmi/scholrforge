    ...
    <div className="space-y-5">
      ...
      <FormField control={form.control} name="title" render={({ field, fieldState }) => (
        <FormItem>
          ...
          <FormControl>
            <input {...field} placeholder="e.g., AI Chatbot Platform"
      ...
      <FormField control={form.control} name="description" render={({ field, fieldState }) => (
        <FormItem>
          ...
          <FormControl>
            <textarea {...field} rows={4} placeholder="Describe your project in detail..."
                ...
                {DIFFICULTY_LEVELS.map(({ value, label }) => (
                  <SelectItem key={value} value={value}>
                    <span className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full" style={{ background: difficultyColors[value] }} />
                      {label}
                    </span>
                  </SelectItem>
                ))}
